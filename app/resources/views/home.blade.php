        ...
        <div class="row">
                            ...
                            document.addEventListener("DOMContentLoaded", () => {
                                new ApexCharts(document.querySelector("#reportsChart1"), {
                                    series: [
                                        {
                                            name: 'Savings',
                                            data: {!! json_encode($expenseBudgetDataSet->pluck('savings')->toArray()) !!},
                                        }
                                    ],
                                    chart: {
                                        height: 350,
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Forecasted Expenses <span>/This Month</span></h5>

                        <!-- Line Chart -->
                        <div id="foreacasts"></div>

                        <script>
                            document.addEventListener("DOMContentLoaded", () => {
                                new ApexCharts(document.querySelector("#foreacasts"), {
                                    series: [
                                        {
                                            name: 'Predicted Expense',
                                            data: {!! json_encode($forecastedExpenses->pluck('predicted_expense')->toArray()) !!},
                                        },
                                    ],
                                    chart: {
                                        height: 350,
                                    ...
                                    xaxis: {
                                        type: 'datetime',
                                        categories: {!!   json_encode($forecastedExpenses->pluck('created_at')->map(fn($date) => $date->toFormattedDateString())->toArray()) !!}
                                    },
                                    tooltip: {
                                        x: {
                                            format: 'dd/MM/yy'
