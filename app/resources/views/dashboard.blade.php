        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    ...
                    <span class="d-none d-md-block dropdown-toggle ps-2">Kumar</span>
    ...
    <section class="section dashboard">
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        ...
                        <div class="card info-card customers-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Friends Connected <span>| This Year</span></h5>
                        ...
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <a class="btn btn-primary">Add Expense</a>
                                    </div>
            ...
            <div class="col-lg-4">
                ...
                <!-- Recent Activity by your friends-->
                <div class="card">
                    <div class="filter">
                        <a class="icon" href="#" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Recent Activity by your friends<span>| Today</span></h5>
                        ...
                        <div class="activity">
                            ...
                            <div class="activity-item d-flex">
                                ...
                                <div class="activity-content">
                                    Sambar Powder, Puliyogare Paste
                                </div>
                ...
                </div><!-- End Recent Activity by your friends -->
                ...
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        <h5 class="card-title">Spending Analysis <span>| This Month</span></h5>
